...
int  main ()
{
    try  {
		...
		NsIntVar x1(pm, 0, 19), x2(pm, 0, 19), x3(pm, 0, 19),
		         y1(pm, 0, 19), y2(pm, 0, 19), y3(pm, 0, 19),
				 a1(pm, 0, 19), a2(pm, 0, 19), a3(pm, 0, 19),
		         b1(pm, 0, 19), b2(pm, 0, 19), b3(pm, 0, 19),
				 c1(pm, 0, 19), c2(pm, 0, 19), c3(pm, 0, 19),
				 o1(pm, 0, 19), o2(pm, 0, 19), o3(pm, 0, 19),
				 o4(pm, 0, 19), o5(pm, 0, 19);
		...
		NsIntVar o = 10000*(o1%10) + 1000*(o2%10) + 100*(o3%10) +
		             10*(o4%10) + o5%10;
